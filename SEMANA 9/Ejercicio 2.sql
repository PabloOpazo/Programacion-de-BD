        ...
        BEGIN
            ...
            EXCEPTION
                    WHEN error_negocio THEN
                        INSERT INTO error_proceso VALUES(seq_error.NEXTVAL, 'No cumple minimo de especialistas', 'ERROR DE NEGOCIO', USER);
        END;
            ...
            BEGIN
                ...
                EXCEPTION
                      WHEN no_data_found THEN
                        msg_oracle := SQLERRM;
                        INSERT INTO error_proceso VALUES(seq_error.NEXTVAL, 'No existe %', msg_oracle, USER);
            END;
